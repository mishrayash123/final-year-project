                               ...
                               <div class="space-x-8 flex justify-between mt-32 md:mt-0 md:justify-center">
                                ...
                                <div class="mt-20 text-center border-b pb-12">  
                                 ...
                                 <p class="mt-2 text-gray-500">Phone No : {profiledata.phone}</p>
                                  ...
                                  <a  href={profiledata.linkedin} className="flex justify-center mt-1" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
